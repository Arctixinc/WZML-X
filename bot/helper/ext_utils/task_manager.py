...
from ..telegram_helper.tg_utils import check_botpm, forcesub
from .bot_utils import sync_to_async, safe_int
...
async def stop_duplicate_check(listener):
    # Duplicates check removed for now as it relied on drive search
    return False, None
